...
ext_modules=[
#    Extension("isu.gui.gtk.cython_module",
#              sources=["src/./isu.gui.gtk/cython_module.pyx"],
#              libraries=["gdal"],
#    )
]
...
setup(
    name='isu.gui.gtk',
    version=version,
    description="GTK gui for ISU Enterprise",
    ...
    #     """.split('\n') if c.strip()],
    # ],
    keywords='ISU Enterprise GTK GUI',
    author='Evgeny Cherkashin',
    author_email='eugeneai@irnok.net',
    url='https://github.com/isu-enterprise/isu.gui.gtk',
    license='GTK>=2',
    packages=find_packages("src"),
    package_dir = {'': "src"},
    namespace_packages = ['isu', 'isu.gui'],
